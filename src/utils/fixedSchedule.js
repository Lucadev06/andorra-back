const buildRange = (start, end, stepMinutes = 30) => {
  const slots = [];
...
export const getFixedSlotsByDate = (date) => SLOTS_BY_DAY[date.getDay()] || [];

export const isTimeAllowedForDate = (date, time) => {
...
export const isDateWithinAdvanceBookingWindow = (date, maxDays = MAX_ADVANCE_BOOKING_DAYS) => {
